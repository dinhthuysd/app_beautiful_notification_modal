...
import { Settings, DollarSign, TrendingUp, Lock, Coins, Shield, FileCheck, MessageSquare } from 'lucide-react';
        ...
        <TabsContent value="telegram">
          <Card>
            ...
            <CardContent className="space-y-6">
              {/* Bot Credentials */}
              <div className="space-y-4">
                <h3 className="font-semibold text-slate-900">Bot Credentials</h3>
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    <Label htmlFor="telegram_admin_chat_id">Admin Chat ID</Label>
                    <Input
                      ...
                      placeholder="Enter admin chat ID or group ID"
                    />
                    <p className="text-xs text-slate-500 mt-1">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                    <div>
                      <Label htmlFor="telegram_notifications_enabled">Enable Notifications</Label>
                      <p className="text-sm text-slate-500">Master switch for all Telegram notifications</p>
                    </div>
                    <Switch
                      id="telegram_notifications_enabled"
                      checked={settings?.telegram_notifications_enabled || false}
                      onCheckedChange={(checked) => updateSetting('telegram_notifications_enabled', checked)}
                    />
                  </div>
                  <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                    <div>
                      <Label htmlFor="telegram_kyc_notifications">KYC Notifications</Label>
                      <p className="text-sm text-slate-500">New KYC submissions</p>
                    </div>
                    <Switch
                      id="telegram_kyc_notifications"
                      checked={settings?.telegram_kyc_notifications || false}
                      onCheckedChange={(checked) => updateSetting('telegram_kyc_notifications', checked)}
                      disabled={!settings?.telegram_notifications_enabled}
                    />
                  </div>
                  <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                    <div>
                      <Label htmlFor="telegram_deposit_notifications">Deposit Notifications</Label>
                      <p className="text-sm text-slate-500">New deposit requests</p>
                    </div>
                    <Switch
                      id="telegram_deposit_notifications"
                      checked={settings?.telegram_deposit_notifications || false}
                      onCheckedChange={(checked) => updateSetting('telegram_deposit_notifications', checked)}
                      disabled={!settings?.telegram_notifications_enabled}
                    />
                  </div>
                  <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                    <div>
                      <Label htmlFor="telegram_withdrawal_notifications">Withdrawal Notifications</Label>
                      <p className="text-sm text-slate-500">New withdrawal requests</p>
                    </div>
                    <Switch
                      id="telegram_withdrawal_notifications"
                      checked={settings?.telegram_withdrawal_notifications || false}
                      onCheckedChange={(checked) => updateSetting('telegram_withdrawal_notifications', checked)}
                      disabled={!settings?.telegram_notifications_enabled}
                    />
                  </div>
                  <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                    <div>
                      <Label htmlFor="telegram_security_alerts">Security Alerts</Label>
                      <p className="text-sm text-slate-500">Security and suspicious activity alerts</p>
                    </div>
                    <Switch
                      id="telegram_security_alerts"
                      checked={settings?.telegram_security_alerts || false}
                      onCheckedChange={(checked) => updateSetting('telegram_security_alerts', checked)}
                      disabled={!settings?.telegram_notifications_enabled}
                    />
                  </div>
                </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
                ...
                <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
                  ...
                  <li>Send <code className="bg-blue-100 px-1 rounded">/newbot</code> and follow instructions to create your bot</li>
                  <li>Copy the bot token and paste it above</li>
                  <li>To get your chat ID, message <strong>@userinfobot</strong> on Telegram</li>
                  <li>For group notifications, add your bot to a group and get the group chat ID</li>
