...
class SystemSettings(BaseModel):
    ...
    telegram_kyc_notifications: bool = True
    telegram_deposit_notifications: bool = True
    telegram_withdrawal_notifications: bool = True
    telegram_security_alerts: bool = True
...
class SystemSettingsUpdate(BaseModel):
    ...
    telegram_kyc_notifications: Optional[bool] = None
    telegram_deposit_notifications: Optional[bool] = None
    telegram_withdrawal_notifications: Optional[bool] = None
