...
async def update_system_settings(
    ...
    # Update Telegram service credentials if provided
    if 'telegram_bot_token' in update_data or 'telegram_admin_chat_id' in update_data:
        from utils.telegram_service import telegram_service
        telegram_service.update_credentials(
            bot_token=update_data.get('telegram_bot_token'),
            admin_chat_id=update_data.get('telegram_admin_chat_id')
        )
